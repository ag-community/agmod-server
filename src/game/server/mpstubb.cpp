...
bool CGraph ::FLoadGraph(char *szMapName) { return false; }
bool CGraph ::AllocNodes(void) { return false; }
bool CGraph ::CheckNODFile(char *szMapName) { return false; }
bool CGraph ::FSetGraphPointers(void) { return 0; }
