...
{
	if ((entity->pev->absmin.x <= point.x && point.x <= entity->pev->absmax.x) && (entity->pev->absmin.y <= point.y && point.y <= entity->pev->absmax.y) && (entity->pev->absmin.z <= point.z && point.z <= entity->pev->absmax.z))
	{
		return true;
	}
