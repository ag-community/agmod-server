...
public:
	...
	bool	Empty( void ) { return (m_pdata == NULL) || ((m_pdata->pCurrentData-m_pdata->pBaseData)>=m_pdata->bufferSize); }
...
public:
	...
	bool			EntityInTable( string_t globalname ) { return (Find( globalname ) != NULL) ? 1 : 0; }
